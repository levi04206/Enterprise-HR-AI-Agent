...
1. 新增 `docs/ARCHITECTURE.md`，整理项目总体架构、RAG 入库流程、对话检索流程、Function Calling 时序和数据表职责。
2. 新增 Mermaid 架构图、RAG 流程图和工具调用时序图，方便 README 和面试讲解。
3. 新增 `docs/screenshots/README.md`，预留项目截图和演示 GIF 的存放规范。
4. 重构 README 顶部展示区，补充项目一句话介绍、项目亮点、技术栈表格、快速演示入口和架构速览。
5. 更新面试指南入口说明，建议先读架构文档再准备面试表达。

### 当前状态

项目展示材料已经补齐。明天通读项目时，可以按 README -> ARCHITECTURE -> INTERVIEW_GUIDE -> 核心代码 的顺序推进。
